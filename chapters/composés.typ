...
Les cinq actifs présentés ont été sélectionnés sur la base de trois critères cumulatifs :
    ...
    - Validation scientifique : Existence de publications documentant les mécanismes d'action et validant l'efficacité clinique pour des indications cutanées précises.
...
Actif de référence pour les *peaux sensibles, réactives ou intolérantes*, le bisabolol est recommandé pour les patients présentant une micro-inflammation chronique (post-rasage, rosacée débutante, peau intolérante). Il convient également aux peaux infantiles ou âgées, dont la barrière lipidique est fragilisée.
...
Bien que très bien toléré, de *rares cas d’hypersensibilité croisée* ont été rapportés chez les sujets allergiques aux composés des Asteraceae (famille de la camomille). Il est donc recommandé de *vérifier l’origine du bisabolol* (naturel vs synthétique) et d’éviter son application sur des lésions ouvertes ou suintantes, en l’absence de données d’innocuité dans ce contexte. L’innocuité en application cutanée est toutefois largement documentée.
...
Des procédés de *lyophilisation* ou de *filtration stérile à froid* permettent également d’obtenir des poudres ou extraits concentrés, plus stables et compatibles avec des émulsions ou des gels aqueux. La dénaturation thermique (>50 °C) des enzymes contenues dans le gel impose une attention particulière lors de l’incorporation dans des produits chauffés.

=== Galéniques courantes
...
Les produits contenant du *latex d’aloès* (aloïne), extrait de la partie périphérique de la feuille, peuvent être irritants voire laxatifs s’ils sont utilisés par voie orale. En usage cosmétique, il convient de *vérifier l’absence d’aloïne* et de *préférer des extraits purifiés*. L’Aloe vera étant instable en solution aqueuse, les produits sans conservateur doivent être *utilisés rapidement après ouverture* et *conservés au frais*. L’usage de formulations contenant de l’alcool est à proscrire sur peaux lésées ou sensibilisées.
