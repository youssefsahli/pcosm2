...
#[
  ...
  → Aloe vera, Centella asiatica, α-Bisabolol
  
  - Peaux grasses ou acnéiques
  → Bakuchiol, Nigella sativa
  
  - Peaux sensibles ou réactives
  → α-Bisabolol, Centella asiatica, Aloe vera
...
Caractérisées par une hyperexcitabilité neurosensorielle et une fragilité de la barrière cutanée, ces peaux nécessitent des actifs apaisants, anti-inflammatoires et hautement tolérés.
...
#csv_table(
  "/data/tables/Actifs_selon_le_type_de_peau.csv", 
  [Actifs utiles selon le type de peau]
)


== Approche par indication clinique

#[
  - Cicatrisation, post-lésion
  → Centella asiatica, Aloe vera
  
  - Rougeurs et inflammations superficielles
  → α-Bisabolol, Centella asiatica
  
  - Eczéma ou dermatite atopique
  → Nigella sativa, α-Bisabolol
  
  - Anti-âge / prévention du vieillissement
  → Bakuchiol, Centella asiatica
  
  - Soins post-épilation, post-laser
  → Aloe vera, α-Bisabolol
] <plan>
...
Les états inflammatoires mineurs (érythèmes, irritations, coups de soleil) nécessitent des actifs inhibant les cytokines pro-inflammatoires (@TNF-α, @IL-6, @IL-1) et la @VoieNFkB.
...
Le vieillissement cutané est marqué par une diminution de l’activité fibroblastique, l’altération de la matrice dermique et l’augmentation du stress oxydatif.

- *Bakuchiol* : stimule la synthèse de collagène, inhibe @MMP, active @RAR/@RXR ; idéal pour les soins nocturnes anti-âge en remplacement du rétinol.

- *Centella asiatica* : les triterpènes renforcent l’architecture dermique, avec une bonne tolérance chez les peaux matures ou fragilisées.

=== Soins post-épilation, post-laser

Après une agression mécanique ou thermique, il convient de restaurer l'intégrité cutanée, réduire l'inflammation et prévenir les infections secondaires.

- *Aloe vera* : effet filmogène immédiat, hydratation rapide, réduction du prurit post-acte.

- *α-Bisabolol* : excellent apaisant post-acte, diminue le temps de récupération ; indiqué dans les soins post-laser doux et épilations mécaniques.

=== Récapitulatif
#csv_table(
  "/data/tables/actifs_par_indication.csv",
  [Actifs utiles selon l'indication]
)

== Populations spécifiques
#[
  - Enfants
  → α-Bisabolol (faible dose), Aloe vera (stabilisé), Centella asiatica (formulations testées)
  
  - Femmes enceintes
  → Éviter les huiles essentielles, usage possible de *Centella asiatica*, *Aloe vera*, *α-Bisabolol* (non oxydé), prudence avec Nigella sativa.
  
  - Peaux masculines / soin de la barbe
  → Nigella sativa, Aloe vera

  - Tableaux récapitulatifs
  → Indications croisées / actif recommandé  
  → Contre-indications / précautions
] <plan>

=== Enfants

La peau infantile est plus fine, plus perméable et plus vulnérable aux agents irritants. Le conseil officinal privilégiera des extraits doux, testés pédiatriquement et exempts de parfums ou conservateurs allergisants.

- *α-Bisabolol* : utilisé en pédiatrie pour son effet calmant et anti-inflammatoire ; présent dans de nombreux soins pour l’érythème fessier, les peaux atopiques ou les irritations. Privilégier les formules sans parfum, avec un bisabolol d’origine naturelle.
...
- *α-Bisabolol* : toléré, non photosensibilisant ni mutagène. Utile en cas de vergetures naissantes, irritations mammaires ou dermatoses gravidiques bénignes.

- *Centella asiatica* : favorise la cicatrisation post-épisiotomie ou césarienne ; utilisé aussi en prévention des vergetures. Préférer les extraits bien caractérisés.

- *Aloe vera* : usage externe sans danger chez la femme enceinte. Éviter en revanche l’ingestion de latex d’aloès, purgatif.

- *Nigella sativa* : déconseillée en usage interne pendant la grossesse. En externe, les données sont limitées ; la prudence reste de mise, notamment pour les soins du cuir chevelu ou les huiles de massage.

=== Peaux masculines / soin de la barbe

La peau masculine est en moyenne plus épaisse, plus grasse, avec une pilosité dense et une réactivité particulière liée au rasage.

- *Nigella sativa* : utilisée pour ses vertus anti-inflammatoires et antiseptiques sur les follicules. Recommandée en huile post-rasage ou dans les sérums barbe.

- *Aloe vera* : bon effet apaisant après-rasage ; son effet filmogène diminue le feu du rasoir.
