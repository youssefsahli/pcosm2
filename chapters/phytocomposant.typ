...
#[
  ...
  Un constituant _phytochimique_ est une molécule que l'on retrouve naturellement dans les tissus végétaux de certaines espèces, et que l'on extrait afin de l'introduire dans une formulation cosmétique. On peut les retrouver en tant qu'excipient, additif, ou actif. On s'intéressera à ce dernier rôle.
...
Les polyphénols constituent une vaste classe de composés organiques caractérisés par la présence d'un ou plusieurs groupements hydroxyles (-OH) attachés à un ou plusieurs cycles aromatiques de type phénol @bertelli_polyphenols_2021. Ils sont très anti-oxydants, et neutralisent efficacement les @ROS @scalbert_polyphenols_2005: Ils préviennent ainsi la peroxydation lipidiques, ainsi que l'altération des protéines et de l'ADN cellulaire.

Au-delà de cette activité anti-oxydante, certains flavonoïdes et acides phénoliques modulent la voie @VoieNFkB et exercent alors une activité anti-inflammatoire. D'autres ont une capacité à inhiber l'activité de la tyrosinase -- intervenant dans la mélanogenèse -- et ont une activité anti-tâche.

=== Les Terpénoïdes (ou Isoprénoïdes)
