...
#let conclusion_text = [
  ...
  Ainsi, malgré les allégations marketing, il est nécessaire pour le pharmacien de connaître les mécanismes d'actions des phytocomposants afin de sécuriser leur utilisation dermatologique et de veiller aux contraintes écologiques qui peuvent se présenter. Ainsi, il est nécessaire même pour une demande en parapharmacie, d'appliquer une méthodologie rigoureuse, en considérant l'acte de conseil non pas comme une simple transaction commerciale, mais comme une étape à part entière du parcours de soin.
